...
public:
	...
	// added!: scroll wheel controls camera movement speed
	static void Mouse_Scroll_Wheel_Callback(GLFWwindow* window, double xoffset, double yoffset);

	// added!: keep viewport in sync on window/framebuffer resize
	static void Window_Resize_Callback(GLFWwindow* window, int width, int height);

	// added!: orthographic projection is currently active
